Vagrant.configure("2") do |config|
  ...
  config.vm.provision :chef_client do |chef|
    ...
    chef.chef_server_url = "https://api.chef.io/organizations/home3"
    chef.validation_key_path = ".chef/home3-validator.pem"
    chef.validation_client_name = "home3-validator"
